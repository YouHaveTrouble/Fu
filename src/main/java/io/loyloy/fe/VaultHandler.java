...
public class VaultHandler implements Economy {
    ...
    private boolean createAccount(String playerName, String uuid) {
        if (hasAccount(playerName, uuid)) return false;
    ...
    public class EconomyServerListener implements Listener {
        ...
        public void onPluginEnable(PluginEnableEvent event) {
            if (plugin == null) {
                Plugin plugin = Bukkit.getServer().getPluginManager().getPlugin("Fu");
        ...
        public void onPluginDisable(PluginDisableEvent event) {
            if (plugin != null) {
                if (event.getPlugin().getDescription().getName().equals(name)) {
                    ...
                    Bukkit.getLogger().info("[Fu] Vault support disabled.");
                }
            }
        }
    }
